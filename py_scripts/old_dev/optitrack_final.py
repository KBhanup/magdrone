    ...
    def send_commands(self):
        ...
        while not rp.is_shutdown():
            ...
            if self.cmds is not None:
                ...
                self.linear_y_cmd = self.clipCommand(uY - 0.65, 7.5, -7.5)
                self.linear_x_cmd = self.clipCommand(uX + 0.66, 7.5, -7.5)
                ...
                cmd.twist.angular.x = self.linear_y_cmd
                cmd.twist.angular.y = -self.linear_x_cmd
                cmd.twist.angular.z = self.angular_z_cmd
                cmd.twist.linear.z = self.linear_z_cmd
