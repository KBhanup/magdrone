...
class magdroneControlNode():
    ...
    def opti_pose_callback(self, data):
    ...
    def opti_rate_callback(self, data):
    ...
    def update_aruco_error(self, X):
        ...
        setpoint = Vector3Stamped()
        setpoint.header.stamp = rp.Time.now()
        setpoint.vector.x = self.des_position[0]
        setpoint.vector.y = self.des_position[1]
        setpoint.vector.z = self.des_position[2]
        self.setpoint_pub.publish(setpoint)
